  ...
  return (
    <div className="flex item justify-between">
      <section className="w-full flex flex-col items gap-6 mt-2 mb-27 lg:max-w-[955px] lg:mt-6 lg:gap-10">
        <article className="border border-line-100 rounded-2xl px-3.5 py-4 flex flex-col gap-3.5 lg:px-6 lg:py-5">
        ...
        <article className="lg:hidden">
          ...
          <div className="flex items-center gap-4">
            ...
            <Image src={shareKakao} alt="카카오 공유" width={40} height={40} />
            <Image
              src={shareFacebook}
              alt="페이스북 공유 공유"
              width={40}
      ...
      <div className="hidden lg:block w-82">
        ...
        <article>
          ...
          <div className="flex items-center gap-4">
            ...
            <Image src={shareKakao} alt="카카오 공유" width={64} height={64} />
            <Image
              src={shareFacebook}
              alt="페이스북 공유 공유"
              width={64}
