                  ...
                  <div className="grid grid-cols-2 divide-x divide-dotted divide-gray-200">
                     {options.map((option) => (
                        <div
                           ...
                           className="text-14-medium lg:text-18-medium hover:bg-hover-100 flex h-9 cursor-pointer items-center justify-start px-2 lg:h-15"
                        >
                           {option.label}
                        </div>
                     ))}
                  ...
                  <div>
                     {options.map((option) => (
                        <div
                           key={option.value}
                           onClick={() => handleSelect(option)}
                           className="text-14-medium lg:text-18-medium hover:bg-hover-100 flex h-9 w-22 cursor-pointer items-center justify-start px-3 lg:h-15 lg:w-80"
                        >
                           {option.label}
                        </div>
                     ))}
