...
export default function ProfileDropdownMenu({ onClose }: Prop) {
   ...
   return (
      <section className="border-line-200 absolute top-9 left-1/2 z-40 inline-flex h-56 w-38 -translate-x-1/2 flex-col items-start rounded-2xl border bg-white p-[10px_6px_6px_6px] shadow-[2px_2px_8px_rgba(224,224,224,0.2)] lg:left-[-2rem] lg:h-74 lg:w-62 lg:p-[16px_4px_6px_4px]">
